...
namespace BinanceExchange.API.Models.Response
{
    ...
    public partial class PlayerQAConfiguration : IEntityTypeConfiguration<PlayerQA>
    {
        public void Configure(EntityTypeBuilder<PlayerQA> builder)
        {
