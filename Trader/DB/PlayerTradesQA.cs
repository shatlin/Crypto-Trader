...
namespace BinanceExchange.API.Models.Response
{
    ...
    public partial class PlayerHistQAConfiguration : IEntityTypeConfiguration<PlayerTradesQA>
    {
        public void Configure(EntityTypeBuilder<PlayerTradesQA> builder)
        {
