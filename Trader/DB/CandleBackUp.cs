...
namespace BinanceExchange.API.Models.Response
{
    ...
    public partial class CandleBackUpConfiguration : IEntityTypeConfiguration<CandleBackUp>
    {
        public void Configure(EntityTypeBuilder<CandleBackUp> builder)
        {
