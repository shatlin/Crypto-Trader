    ...
    public partial class BalanceView : UserControl
    {
        ...
        private  void CalculateBalanceSummary()
        {
            try
            {
                ...
                lblInvested.Content = "Invested : " + String.Format("{0:0.00}", totalinvested);
                lblCurrentValue.Content = "Current Value :" + String.Format("{0:0.00}", totalcurrent);
                lblDifference.Content = "Difference : " + String.Format("{0:0.00}", totaldifference);
                lblDifferencePercentage.Content = "Difference % :" + String.Format("{0:0.00}", totaldifferenceinpercentage);
            }
            catch (Exception ex)
            {
